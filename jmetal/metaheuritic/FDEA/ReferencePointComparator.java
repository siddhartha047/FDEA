 ...
 */
public class ReferencePointComparator implements Comparator {
	 ...
	 */
	public ReferencePointComparator(int nObj) {
		this.nObj = nObj;
	} // ObjectiveComparator
	...
	public int compare(Object o1, Object o2) {
		...
		double objetive1 = ((ReferencePoint) o1).getObjective(this.nObj);
		double objetive2 = ((ReferencePoint) o2).getObjective(this.nObj);
