...
public class ReferencePointAlgoModified {
	
	//SidRefDistance sidRefDistanceCrowd = new SidRefDistance();
	SidRefDistanceSort sidRefDistanceSort = new SidRefDistanceSort();
	//SidRefDistance sidRefDistanceSort = new SidRefDistance();
