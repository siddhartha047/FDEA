...
public class FuzzyRankingFDEA {	  
	   ...
	   */       
	  public FuzzyRankingFDEA(SolutionSet solutionSet, MemParamEstimationSigMoid refmemberfunction) {        
	    ...
	    refmemberfunction.Initialization(solutionSet);
