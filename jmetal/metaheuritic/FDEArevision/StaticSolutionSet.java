...
public class StaticSolutionSet {
	...
	public static SolutionSet MakeTwoObjectiveSolution(SolutionSet solutionSet){
		...
		objectives1[0]=0.1; objectives1[1]=0.9;
		objectives2[0]=0.2; objectives2[1]=0.8; 
		objectives3[0]=0.3; objectives3[1]=0.7; 
		objectives4[0]=0.4; objectives4[1]=0.6;
		objectives5[0]=0.45; objectives5[1]=0.55;
		objectives6[0]=0.15; objectives6[1]=0.85;
