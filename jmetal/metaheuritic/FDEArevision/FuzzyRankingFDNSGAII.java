...
public class FuzzyRankingFDNSGAII {	  
	  /**
	   ...
	   */       
	  public FuzzyRankingFDNSGAII(SolutionSet solutionSet, MemParamEstimationGaussian refmemberfunction) {        
	    ...
	    refmemberfunction.setfmaxfmins(solutionSet_);
	    ...
	    while(solutionSet_.size()!=0){
	    	...
	    	for(int i = 0; i < solutionSet_.size(); i++){
	    		solutionSet_.get(i).setFitness(0);
	    	}
	    	
	    	refmemberfunction.FitnessAssignment(solutionSet_);
