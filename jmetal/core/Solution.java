...
public class Solution implements Serializable {  
  ...
  private double [] fuzzy_objective_ ;
  private double []betterCount;
  private double maxgamma;
  public double  []gridValues;
  public double distance;
  public double []mObjective=new double[2];
  
  //added for polar
  public double lifeTime = 0;
  public boolean firstSweep=true;
...
//   */
  ...
  public Solution(int numberOfObjectives) {
    ...
    fuzzy_objective_          = new double[numberOfObjectives];
    betterCount=new double[numberOfObjectives];
  }
  ...
  public Solution(Problem problem) throws ClassNotFoundException{
    ...
    fuzzy_objective_          = new double[numberOfObjectives_];
    betterCount=new double[numberOfObjectives_];
  ...
  public Solution(Solution solution) {            
    ...
    for (int i = 0; i < objective_.length;i++) {
      ...
      fuzzy_objective_[i] =solution.get_Fuzzy_objective_value(i);
      betterCount[i]=solution.getbetterCount_value(i);
    } // for
    //<-
  ...
  public void setFuzzy_objective_value(double val,int index){
      fuzzy_objective_[index]=val;
  }
  public double get_Fuzzy_objective_value(int index){
      return  fuzzy_objective_[index];
  }
  public double[] get_fuzzy_objectives(){
      return fuzzy_objective_;
  }
  
  
  public double[] getBetterCount(){
      return betterCount;
  }
  
  public void setbetterCount_value(double val,int index){
      betterCount[index]=val;
  }
  public double getbetterCount_value(int index){
      return  betterCount[index];
  }
  
  public double [] get_objectives(){
      return objective_;
  }
  public void setmaxgamma(double gamma){
      this.maxgamma=gamma;
  }
  /**
