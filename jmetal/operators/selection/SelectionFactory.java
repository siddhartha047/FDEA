...
public class SelectionFactory {
  ...
  public static Selection getSelectionOperator(String name, HashMap parameters) throws JMException {
    ...
    else if( name.equalsIgnoreCase("SidBinaryTournament")){
    	return new SidBinaryTournament(parameters);
    }
    else if( name.equalsIgnoreCase("PolarBinaryTournament")){
    	return new PolarBinaryTournament(parameters);
    }
    else {
