...
public class MOEAD extends AbstractAlgorithm {
	...
	public MOEAD(Problem problem, int neighborhoodSize,
		...
		System.out.println(this.variation.getClass());
		System.out.println(this.variation.toString());
		this.delta = delta;
		this.eta = eta;
		this.updateUtility = updateUtility;
	System.out.println(updateUtility);
	...
	public void iterate() {
		...
		for (Integer index : indices) {
			...
			System.out.println(variation.getArity());
			System.exit(1);
			...
			//System.out.println("h: "+numberOfEvaluations);
			for (Solution child : offspring) {
				evaluate(child);
				updateIdealPoint(child);
				updateSolution(child, matingIndices);
			}
			//System.out.println("l: "+numberOfEvaluations);
