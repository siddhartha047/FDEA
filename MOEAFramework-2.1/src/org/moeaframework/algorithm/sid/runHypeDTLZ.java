...
public class runHypeDTLZ {
	...
	public static void main(String[] args) {
		...
		String directory = "E:\\Thesis lab experiment documents\\abcgenerations\\perfectWFG-DTLZ\\perfectHYPE\\";
		...
		for (int dimno = 0; dimno < dimArr.length; dimno++) {
			...
			for (int wfgProblemNo = 0; wfgProblemNo < wfgno.length; wfgProblemNo++) {             
				...
				String resultFile = "hypeDTLZ" + wfgno[wfgProblemNo] + "_"
						+ String.valueOf(M) + ".pf";
